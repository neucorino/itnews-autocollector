...
出力形式は必ずシステムプロンプトで指定されたJSON形式にしてください。
"""
...
提供されるタイトルと内容から、以下の基準で【メリハリをつけて】スコアリングしてください。
特に、実用的なAI関連のニュースには積極的に7〜10点の高得点をつけてください。
...
{
    "ai_summary": "タイトルと内容から推測される内容を2〜3行で要約（日本語）",
    "importance": 数値(1-10),
